...
test_case "Empty YAZPT_VCS_STATUS_DIRTY_CHAR (YAZPT_CHECK_TFVC_LOCKS=true)"
reset_tfvc_status_chars
...
test_case "Empty YAZPT_VCS_STATUS_LOCKED_CHAR (YAZPT_CHECK_TFVC_LOCKS=true)"
reset_tfvc_status_chars
YAZPT_CHECK_TFVC_LOCKS=true
...
test_case "Empty YAZPT_VCS_STATUS_DIRTY_CHAR (YAZPT_CHECK_TFVC_LOCKS=false)"
reset_tfvc_status_chars
